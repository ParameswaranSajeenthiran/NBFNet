...
from memory_temporal_nbfnet import NeuralBellmanFordNetworkTemporal
from memory_temporal_tasks import TemporalKnowledgeGraphCompletionMemory
...
def load_local_icews(data_dir="data/ICEWS14", valid_ratio=0.01, seed=42):
    """
    ...
    full_train = read_file(os.path.join(data_dir, "train.txt") ,0, 4321)
    test = read_file(os.path.join(data_dir, "test.txt"),4344, 6000)
...
def main(
    ...
    evaluate_only=True,
    checkpoint_path="/home/sajeenthiranp/KG/fork/NBFNet/nbfnet/data/ICEWS14/model_epoch_2.pt",
